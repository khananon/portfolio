...
const Experience = () => {
  ...
  transition={{duration:1}}
   className="my-12 text-center text-4xl">Experience</motion.h2>
  <div>
        ...
        transition={{duration:1}}
         className="w-full max-w-xl lg:w-3/4">
            ...
            {experience.technologies.map((tech,index)=>(
                <span key={index} className="mb-4 mr-2 rounded bg-neutral-900 px-2 py-1 text-sm text-purple-600 ">{tech}</span>
            ))}
        </motion.div>
      </div>
    ))
